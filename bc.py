...
def broadcast_message(message):
    ...
    if user_id in admin_id:
        ...
        if len(command) > 1:
            message_to_broadcast = "AGR MERI FILE SAHI SE WORK NHI KR RHI TI PAID LO 300 SEC OWNER @TOXICPLAYER002:\n\n" + command[1]
            with open(USER_FILE, "r") as file:
                user_ids = file.read().splitlines()
                for user_id in user_ids:
                    try:
...
while True:
 ...
 #https://t.me/Kasukabe1 OWMER TOXICPLAYER002
